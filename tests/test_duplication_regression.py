...
class TestDuplicationAPIContract:
    ...
    async def test_api_endpoint_construction(self, enable_feature):
        ...
        test_cases = [
            ("campaign", "123456789", "https://mcp.platform.titanmindhq.com/api/meta/duplicate/campaign/123456789"),
            ("adset", "987654321", "https://mcp.platform.titanmindhq.com/api/meta/duplicate/adset/987654321"),
            ("ad", "555666777", "https://mcp.platform.titanmindhq.com/api/meta/duplicate/ad/555666777"),
            ("creative", "111222333", "https://mcp.platform.titanmindhq.com/api/meta/duplicate/creative/111222333"),
        ]
        ...
        with patch("meta_ads_mcp.core.auth.get_current_access_token") as mock_get_token:
            with patch("meta_ads_mcp.core.auth.auth_manager") as mock_auth_manager:
                with patch("meta_ads_mcp.core.auth.meta_config") as mock_meta_config:
                    ...
                    mock_auth_manager.use_titanmind = False
            ...
            with patch("meta_ads_mcp.core.auth.auth_manager") as mock_auth_manager:
                with patch("meta_ads_mcp.core.auth.meta_config") as mock_meta_config:
                    ...
                    with patch("meta_ads_mcp.core.duplication.httpx.AsyncClient") as mock_client:
                        ...
                        assert actual_result["details"]["upgrade_url"] == "https://platform.titanmindhq.com/upgrade"

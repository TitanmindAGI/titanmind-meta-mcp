...
- [Email Support](info@platform.titanmindhq.com). Email us for support.
...
The fastest and most reliable way to get started is to **[🚀 Get started with our Meta Ads Remote MCP](https://platform.titanmindhq.com)**. No technical setup required - just connect and start analyzing your ad campaigns with AI!
...
2. Click "Add Integration" and enter:
   - **Name**: "Titanmind Meta Ads" (or any name you prefer)
   - **Integration URL**: `https://mcp.platform.titanmindhq.com/meta-ads-mcp`
...
```json
{
  "mcpServers": {
    "meta-ads-remote": {
      "url": "https://mcp.platform.titanmindhq.com/meta-ads-mcp"
    }
  }
}
```
...
Use the Remote MCP URL: `https://mcp.platform.titanmindhq.com/meta-ads-mcp`

**[📖 Get detailed setup instructions for your AI client here](https://platform.titanmindhq.com)**
...
**[✨ Get started with Remote MCP here](https://platform.titanmindhq.com)** - no technical setup required! Just connect your Facebook Ads account and start asking AI to analyze your campaigns.
...
The easiest way to avoid any setup issues is to **[🎯 use our Remote MCP instead](https://platform.titanmindhq.com)**. No downloads, no configuration - just connect your ads account and start getting AI insights on your campaigns immediately!

...
if ENABLE_DUPLICATION:
    ...
    async def duplicate_campaign(
        ...
        **This is a premium feature available with Titanmind Pro.**
...
async def _forward_duplication_request(resource_type: str, resource_id: str, access_token: str, options: Dict[str, Any]) -> str:
    ...
    try:
        ...
        base_url = "https://mcp.platform.titanmindhq.com"
            ...
            if response.status_code == 200:
                ...
                return json.dumps({
                    ...
                    "details": {
                        ...
                        "upgrade_url": "https://platform.titanmindhq.com/upgrade",
                        "contact_email": "info@platform.titanmindhq.com",

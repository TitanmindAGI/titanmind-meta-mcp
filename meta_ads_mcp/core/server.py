...
class StreamableHTTPHandler:
    ...
    def get_auth_config_from_headers(self, request_headers: Dict[str, str]) -> Dict[str, Any]:
        ...
        ALLOWED_VIA_HEADERS = {
            'titanmind_api_token': True,   # ✅ Primary method - simple and secure
        ...
        return {
            ...
            'error': {
                ...
                'data': {
                    ...
                    'documentation': 'https://github.com/titanmind-co/meta-ads-mcp'
                }
            },
            'id': request_body.get('id')
        }
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="For more information, see https://github.com/titanmind-co/meta-ads-mcp"
    )
    ...
    # Check for Titanmind authentication and token
    titanmind_api_token = os.environ.get("TITANMIND_API_TOKEN")
    if titanmind_api_token:
        logger.info("Using Titanmind authentication")
        # Check for existing token
        token = titanmind_auth_manager.get_access_token()
        if not token:
            logger.info("No valid Titanmind token found. Initiating browser-based authentication flow.")
            ...
            try:
                ...
                if login_url:
                    ...
                    for attempt in range(max_attempts):
                        ...
                        token = titanmind_auth_manager.get_access_token(force_refresh=True)
                        if token:
                    ...
                    logger.error("No login URL received from Titanmind API")
